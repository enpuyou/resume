...
\begin{document}
\name{Enpu You}
\tagline{Software Developer, Pianist}
% Cropped to square from https://en.wikipedia.org/wiki/Marissa_Mayer#/media/File:Marissa_Mayer_May_2014_(cropped).jpg, CC-BY 2.0
%\photo{3.3cm}{profile.jpg}
\personalinfo{%
  % Not all of these are required!
  % You can add your own with \printinfo{symbol}{detail}
  \email{youenpu@gmail.com}
  \phone{814-350-0320}
%  \mailaddress{Address, Street, 00000 County}
  \location{Meadville, PA}
  \homepage{enpuyou.netlify.app}
%  \twitter{@marissamayer}
  \github{github.com/enpuyou}
  \linkedin{linkedin.com/in/enpuyou}
...
\cvevent{Bachelor of Science}{Allegheny College}{Aug 2017--May 2021}{Meadville, PA}
\begin{itemize}
...
\cvhonor{Computer Science Faculty Prize}{}{May 2021}{}
\begin{itemize}
...
\end{itemize}
\smallskip
\cvhonor{Edith Mead Osborne Memorial Fund Prize}{}{May 2021}{}
\begin{itemize}
...
\end{itemize}
\smallskip
\cvhonor{Distinguished Alden Scholar}{}{2018 - 2021}{}
\begin{itemize}
\item Academic honor for maintaining a 3.80 or higher grade point average for the year.
\end{itemize}
\smallskip
\cvhonor{Outstanding Junior Major Prize}{}{May 2020}{}
\begin{itemize}
